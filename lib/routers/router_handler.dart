...
var feedbackPageHandler = Handler(
  handlerFunc: (BuildContext context, Map<String, List<String>> params) {
    return FeedBackPage();
  });

var changenickHandler = Handler(
  handlerFunc: (BuildContext context, Map<String, List<String>> params) {
    return ChangeNickNamePage();
  });

var changedescHandler = Handler(
  handlerFunc: (BuildContext context, Map<String, List<String>> params) {
    return ChangeDescPage();
  });

var personMyFollowHandler = Handler(
  handlerFunc: (BuildContext context, Map<String, List<String>> params) {
    return FollowPage();
  });

var personFanHandler = Handler(
  handlerFunc: (BuildContext context, Map<String, List<String>> params) {
    return FanPage();
  });
...
var weiboPublishHandler = Handler(
  handlerFunc: (BuildContext context, Map<String, List<String>> params) {
    return WeiBoPublishPage();
  });

var weiboPublishAtUsrHandler = Handler(
  handlerFunc: (BuildContext context, Map<String, List<String>> params) {
    return WeiBoPublishAtUserPage();
  });

var weiboPublishTopicHandler = Handler(
  handlerFunc: (BuildContext context, Map<String, List<String>> params) {
    return WeiBoPublishTopicPage();
  });

var weiBoCommentDetailHandler = Handler(
  handlerFunc: (BuildContext context, Map<String, dynamic> params) {
...
var hotSearchHandler = Handler(
  handlerFunc: (BuildContext context, Map<String, dynamic> params) {
    return HotSearchPage();
  });

var msgZanHandler = Handler(
  handlerFunc: (BuildContext context, Map<String, dynamic> params) {
    return MsgZanPage();
  });

var msgCommentHandler = Handler(
  handlerFunc: (BuildContext context, Map<String, dynamic> params) {
    return MsgCommentPage();
  });

var videoetailHandler = Handler(
  handlerFunc: (BuildContext context, Map<String, dynamic> params) {
    VideoModel mVideo =
