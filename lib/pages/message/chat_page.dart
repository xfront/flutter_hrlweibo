...
class _ChatPageState extends State<ChatPage> {
  ...
  List<HrlMessage> mlistMessage = List();
  ...
  getHistroryMessage() {
    print("获取历史消息");
    List<HrlMessage> mHistroyListMessage = List();
    final HrlTextMessage mMessgae = HrlTextMessage();
    mMessgae.text = "测试消息";
    mMessgae.msgType = HrlMessageType.text;
    mMessgae.isSend = false;
    mHistroyListMessage.add(mMessgae);
    mHistroyListMessage.add(mMessgae);
    final HrlImageMessage mMessgaeImg = HrlImageMessage();
            ...
            children: <Widget>[*/
                ...
                ChatBottomInputWidget(
                  ...
                  onImageSelectCallBack: (value) {
                    ...
                    final HrlImageMessage mMessgae = HrlImageMessage();
                    mMessgae.uuid = Uuid().v4() + "";
                  ...
                  onAudioCallBack: (value, duration) {
                    final HrlVoiceMessage mMessgae = HrlVoiceMessage();
                    mMessgae.uuid = Uuid().v4() + "";
