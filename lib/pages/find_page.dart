...
class _FindPageState extends State<FindPage> {
              ...
              SliverToBoxAdapter(
                child: Container(
                  ...
                  child: ConstrainedBox(
                    ...
                    constraints:
                    BoxConstraints.loose(Size(300, 100.0))),
                ),
              ),
              SliverToBoxAdapter(
                child: Container(
  ...
  Widget mHotSearchTopItem(BuildContext context, int index, List<Findhottop> mItemList) {
  ...
  Widget mFindKindItem(BuildContext context, int index, List<Findkind> mItemList) {
    if (mItemList.length == 0) return Container();
    Widget mKindChild;
    if (index == 5) {
